 ...
 */
class ChartUtil(private val context: Context, private val lineChart: LineChart, resData: ArrayList<WaterHistoryData>,
...
//            dataSet.setValueFormatter { value, entry, dataSetIndex, viewPortHandler -> mFormat.format(value) }
...
//            }
            ...
            dataSets.add(dataSet) // icon_add the datasets
